...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    var firebaseConfig = {
        apiKey: "AIzaSyBd1hHs8WcCOAjaJQqvRARKLivO37KN8Ns",
        authDomain: "overview-74404.firebaseapp.com",
        projectId: "overview-74404",
        storageBucket: "overview-74404.appspot.com",
        messagingSenderId: "353229987766",
        appId: "1:353229987766:web:c3998c61547fa8c9f9ab17",
        measurementId: "G-2LY5L8ZY6P"
    };
    var app$1 = initializeApp(firebaseConfig);

    var authErrors = ["auth/invalid-email", "auth/wrong-password"];
    function isAuthError(result) {
        return typeof result === "string";
    }
    function login(email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var auth, userCredential, error_1, errorObj_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        errorObj_1 = error_1;
                        return [2 /*return*/, authErrors.some(function (error) { return errorObj_1.code == error; })
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			attr_dev(li, "class", "text-danger");
    			add_location(li, file, 46, 20, 1797);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*errors*/ 4 && t_value !== (t_value = /*error*/ ctx[7] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(46:16) {#each errors as error}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			p = element("p");
    			p.textContent = "Use a sua conta de Administrador";
    			t4 = space();
    			ul = element("ul");
    			...
    			label1.textContent = "Palavra-passe";
    			t10 = space();
    			...
    			document.title = "Overview - Panorama back office platform";
    			attr_dev(h4, "class", "svelte-12v20oq");
    			add_location(h4, file, 42, 12, 1625);
    			attr_dev(p, "class", "mb-2 svelte-12v20oq");
    			add_location(p, file, 43, 12, 1652);
    			attr_dev(ul, "class", "errors svelte-12v20oq");
    			add_location(ul, file, 44, 12, 1717);
    			attr_dev(header, "class", "mb-2 svelte-12v20oq");
    			add_location(header, file, 41, 8, 1591);
    			attr_dev(label0, "for", "emailInput");
    			attr_dev(label0, "class", "form-label");
    			add_location(label0, file, 51, 12, 1933);
    			attr_dev(input0, "type", "email");
    			attr_dev(input0, "class", input0_class_value = "form-control " + (/*errors*/ ctx[2].length > 0 ? 'is-invalid' : ''));
    			attr_dev(input0, "placeholder", "nome@researcher.com");
    			attr_dev(input0, "id", "emailInput");
    			add_location(input0, file, 54, 12, 2032);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file, 50, 8, 1902);
    			attr_dev(label1, "for", "passwdInput");
    			attr_dev(label1, "class", "form-label");
    			add_location(label1, file, 63, 12, 2332);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "class", input1_class_value = "form-control " + (/*errors*/ ctx[2].length > 0 ? 'is-invalid' : ''));
    			attr_dev(input1, "placeholder", "palavra-passe");
    			attr_dev(input1, "id", "passwdInput");
    			add_location(input1, file, 66, 12, 2440);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file, 62, 8, 2301);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file, 75, 12, 2748);
    			attr_dev(div2, "class", "form-footer svelte-12v20oq");
    			add_location(div2, file, 74, 8, 2710);
    			attr_dev(form, "class", "svelte-12v20oq");
    			add_location(form, file, 40, 4, 1576);
    			attr_dev(main, "class", "svelte-12v20oq");
    			add_location(main, file, 39, 0, 1565);
    		},
    		l: function claim(nodes) {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*tryLogin*/ ctx[3], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*errors*/ 4 && input0_class_value !== (input0_class_value = "form-control " + (/*errors*/ ctx[2].length > 0 ? 'is-invalid' : ''))) {
    			...
    			if (dirty & /*errors*/ 4 && input1_class_value !== (input1_class_value = "form-control " + (/*errors*/ ctx[2].length > 0 ? 'is-invalid' : ''))) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const tryLogin = () => __awaiter(void 0, void 0, void 0, function* () {
    		const email_regex = /^\w+@panorama.com$/;
    		const password_regex = /^\w{8,}$/;

    		if (!email_regex.test(email)) {
    			$$invalidate(2, errors = ["Introduza um email válido"]);
    		}

    		if (!password_regex.test(password)) {
    			$$invalidate(2, errors = [...errors, "Introduza uma palavra-passe com pelo menos 8 caracteres"]);
    		}
    		...
    		let loginResult = yield login(email, password);

    		if (isAuthError(loginResult)) {
    			$$invalidate(2, errors = ["Palavra-passe ou e-mail estão inválidos"]);
    			return;
    		}
    	...
    	return [email, password, errors, tryLogin, input0_input_handler, input1_input_handler];
    }
